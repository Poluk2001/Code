                                        ...
                                        <div class="row animated-panel zoomIn" style="animation-delay: 0.1s;">
                                            <div class="form-group col-lg-6 animated-panel zoomIn"
                                                ...
                                                <input name="name" class="form-control" type="text"
                                                       placeholder="商品名称" value="<%=rsProduct.getString("name")%>">
                                            </div>
                                            <div class="form-group col-lg-6 animated-panel zoomIn"
                                                 style="animation-delay: 0.2s;">
                                                <label>所属分类</label>
                                                <select id="categoryId" name="categoryId" class="form-control">
                                                    ...
                                                    %>
                                                    <option
                                                            <%if (rsCategory.getInt("id") == rsProduct.getInt("category_id")) {%>
                                                            selected
                                                            <%}%>
                                                            value="<%=rsCategory.getString("id")%>"><%=rsCategory.getString("name")%>
                                                    </option>
                                                    <%}%>
                                                </select>
                                            </div>
                                        ...
                                        <div class="row animated-panel zoomIn" style="animation-delay: 0.3s;">
                                            <div class="form-group col-lg-6 animated-panel zoomIn"
                                                ...
                                                <input name="price" class="form-control" type="text"
                                                       placeholder="市场价格" value="<%=rsProduct.getString("price")%>">
                                            </div>
                                            ...
                                            <div class="form-group col-lg-6 animated-panel zoomIn"
                                                ...
                                                <input name="shopPrice" class="form-control" type="text"
                                                       placeholder="店内价格"
                                                       value="<%=rsProduct.getString("shop_price")%>">
                                            </div>
                                        </div>
